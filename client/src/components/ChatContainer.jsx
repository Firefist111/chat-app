  ...
  return selectedUser? (
    <div className='h-full overflow-scroll relative backdrop-blur-2xl'>
      ...
      <div className='flex items-center gap-3 py-5 mx-4 border-b border-stone-500'>
        ...
        <p className='flex-1 text-lg text-white flex items-center gap-2'>Martin Johnson  <span className='w-2 h-2 rounded-full bg-green-500'></span> 
        </p>
        <img onClick={()=>{
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-50/6 px-3 rounded-full'>
          <input type="text" className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-500' placeholder='Send message'/>
          <input type="file" className='' id="image" accept='image/png,image/jpg' hidden/>
          <label htmlFor="image">
            <img src={assets.gallery_icon} alt="" className='wi5 mr-2 cursor-pointer'/>
          </label>
        </div>
    ...
    <div className='flex felx-col items-center justify-center gap-2 text-gray-300 bg-white/10 max-md:hidden'>
